...
public class EmployeeManageProfileController {
	...
	public ResponseEntity<EmployeeContactDetailsResponseDto> updateContactDetails(
		...
		EmployeeContactDetailsResponseDto contactDto = employeeService.updateEmployeeContactDetails(employeeId,
				patchDto);
	...
	@PreAuthorize("hasRole('EMPLOYEE')")
	public ResponseEntity<EmployeeDesignationRoleResponseDto> getDesignationRoleByEmployeeId(
			Authentication authentication) {
		Long employeeId = (Long) authentication.getDetails();
		EmployeeDesignationRoleResponseDto dto = employeeService.getDesignationAndRoleByEmployeeId(employeeId);
